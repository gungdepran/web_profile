...
<div class="sidebar d-flex flex-column flex-shrink-0 p-3 text-white bg-dark">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li><a href="{{ route('admin.videos.index') }}" class="nav-link active" aria-current="page"><i class="bi bi-camera-video-fill"></i> Manajemen Video</a></li>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h1 class="card-title mb-0" style="font-size: 1.5rem;">Edit Video</h1>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.videos.update', $video->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('judul') is-invalid @enderror" id="judul" name="judul" value="{{ old('judul', $video->judul) }}" required>
                        @error('judul')
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('kode_embed') is-invalid @enderror" id="kode_embed" name="kode_embed" rows="4" required>{{ old('kode_embed', $video->kode_embed) }}</textarea>
