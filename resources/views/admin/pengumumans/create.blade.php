...
<head>
    ...
    <title>Admin Panel - Tambah Pengumuman</title>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h1 class="card-title mb-0" style="font-size: 1.5rem;">Tambah Pengumuman Baru</h1>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.pengumumans.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('tanggal_kegiatan') is-invalid @enderror" id="tanggal_kegiatan" name="tanggal_kegiatan" value="{{ old('tanggal_kegiatan') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('sumber') is-invalid @enderror" id="sumber" name="sumber" value="{{ old('sumber') }}" placeholder="Contoh: Majelis Desa Adat Gianyar">
                        @error('sumber')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
